...
#line hidden
        ...
        [NUnit.Framework.CategoryAttribute("Addition")]
        [NUnit.Framework.TestCaseAttribute("0", "11", "3", null)]
        [NUnit.Framework.TestCaseAttribute("10", "11", "11", null)]
        [NUnit.Framework.TestCaseAttribute("11", "11", "15", null)]
        public virtual void AddZerosForSpecialCases(string val1, string val2, string val3, string[] exampleTags)
        {
...
#line hidden
#line 17
    testRunner.When(string.Format("I have entered {0} and {1} into the calculator and press add", val1, val2), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 18
    testRunner.Then(string.Format("the result should be {0}", val3), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
